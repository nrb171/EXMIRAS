%% extracts "abbreviated" files from full CM1 output files
% this script extracts a subset of variables from the full CM1 output files
% and saves them to a new folder. This is useful for saving disk space and
% for speeding up the loading of the files for analysis.
app.FileList = dir('/export/wind1/bradklotz/CM1_SQUALL_LINE_100m/');
...
abbreviatedFolder = ['/export/wind1/nbarron/CM1_SQUALL_LINE_100m/', '/abbreviated/'];
